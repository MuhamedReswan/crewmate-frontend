      ...
      {isOpen && (
        <nav className="md:hidden bg-white border-t border-gray-200">
          <ul className="flex flex-col items-center space-y-4 py-4">
            ...
            <Link to="/services" className={linkClass("/services")} onClick={toggleMenu}>
              Services
            </Link>
            <Link to="/about" className={linkClass("/about")} onClick={toggleMenu}>
              About
            </Link>
            <Link to="/contact" className={linkClass("/contact")} onClick={toggleMenu}>
              Contact
            </Link>
            <button
              onClick={() => {
