       ...
       <footer className="bg-white pt-12 pb-6 border-t">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <img src={crewmateLogo} alt="site logo" className='h-10 w-10 mr-1 mb-' />
            <h1 className="text-2xl font-bold text-[#4B49AC]">CrewMate</h1>
              ...
              <div className="flex space-x-4">
                <Link to="#" className="text-gray-400 hover:text-[#4B49AC]">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><Link to="#" className="hover:text-[#4B49AC]">Event Planning</Link></li>
                <li><Link to="#" className="hover:text-[#4B49AC]">Corporate Events</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><Link to="#" className="hover:text-[#4B49AC]">Blog</Link></li>
                <li><Link to="#" className="hover:text-[#4B49AC]">Contact Us</Link></li>
              </ul>
            </div>
            <div>
