      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-8">
          ...
          <div className="flex items-center space-x-6">
            <a href="#" className="text-indigo-700 font-medium border-b-2 border-indigo-700">
              Home
            </a>
        ...
        <div className="flex items-center space-x-6">
          <button
            className="bg-indigo-700 text-white px-6 py-1.5 rounded hover:bg-indigo-800 transition-colors"
