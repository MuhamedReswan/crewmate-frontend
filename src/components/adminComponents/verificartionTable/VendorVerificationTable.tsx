...
type VerificationData = Partial<Vendor>;
...
const VendorVerificationTable: React.FC<VerificationTableProps> = ({ filteredData, currentPage, limit, onRemove }) => {
            ...
            <Table>
                <TableHeader>
                    <TableRow className="border-b border-[#8B5CF6]/20 hover:bg-[#1F2037]/50">
                        ...
                        <TableHead className="text-gray-300 font-semibold">ESTD</TableHead>
                        <TableHead className="text-gray-300 font-semibold">Location</TableHead>
                        <TableHead className="text-gray-300 font-semibold">Licence Number</TableHead>
                    ...
                    {filteredData.map((item, index) => {
                        return (
                            ...
                            >
                                ...
                                <TableCell className="text-white">{item.estd}</TableCell>
                                <TableCell className="text-white">{item.location?.address}</TableCell>
                                <TableCell className="text-white">{item.licenceNumber}</TableCell>
                                <TableCell>
...
export default React.memo(VendorVerificationTable);
