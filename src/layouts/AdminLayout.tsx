...
const AdminLayout = () => {
  ...
  return (
    <div
      className={`${theme} admin flex h-screen bg-background text-foreground transition-colors duration-300`}
    >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {!shouldHideLayout && <AdminHeader theme={theme} setTheme={setTheme} />}
