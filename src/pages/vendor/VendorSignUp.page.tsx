...
//     console.log(data);
//     // Add your signup logic here, like API call
//   };
...
//           />
//            <img src={crewmateLogo} alt="logo" style={{ width: '45px', height: '45px' }}/>
...
//                   <Input id="name" placeholder="Enter your full name" className="p-1.5 h-8" />
//                 </div>
                
//                 <div className="space-y-1">
//                   <Label htmlFor="email">Email address</Label>
//                   <Input id="email" type="email" placeholder="Enter your email" className="p-1.5 h-8" />
//                 </div>
                
//                 <div className="space-y-1">
//                   <Label htmlFor="mobile">Mobile Number</Label>
//                   <Input id="mobile" type="mobile" placeholder="Enter your mobile number" className="p-1.5 h-8" />
//                 </div>
                
//                 <div className="space-y-1 ">
//                   <Label htmlFor="password">Password</Label>
//                   <Input id="password" type="password" placeholder="Create password" className="p-1.5 h-8" />
//                 </div>
                
//                 <div className="space-y-1">
//                   <Label htmlFor="confirm-password">Confirm Password</Label>
//                   <Input id="confirm-password" type="password" placeholder="Confirm password" className="p-1.5 h-8" />
//                 </div>
...
//                 <Button className="w-full bg-[#4B49AC] hover:bg-[#3f3d91] h-8">
//                   Sign Up
//                 </Button>
