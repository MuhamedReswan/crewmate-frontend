import { getVendorVerificationRequests } from '@/api/admin/admin';
import VendorVerificationTable from '@/components/adminComponents/verificartionTable/VendorVerificationTable';
...
const VendorVerfication = () => {
  ...
  const [verificationData, setVerificationData] = useState<Vendor[]>([]);
 ...
 setVerificationData(result.data.filter((x): x is Vendor => Boolean(x)));
        }
      } catch (error) {
        toast({
...
const filteredData = useMemo(() => {
  return verificationData.filter((item): item is Vendor => {
