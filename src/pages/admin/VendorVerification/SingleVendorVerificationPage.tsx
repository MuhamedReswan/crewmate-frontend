...
export default function VendorVerificationDetails() {
  ...
  const handleVerify = useCallback(
    async (status: VerificationStatus, reason?: string) => {
      ...
      setIsLoading(true);
      try {
        const result = await verifyUserByAdmin(UserType.VENDOR, id, status, reason);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-surface-foreground">
                      {VendorData.location?.address || "N/A"}
                    </p>
                  </div>
                </div>
            ...
            <DocumentViewer
              title="Licence Image"
              documents={[{ label: "Licence", url: licenceImageSrc }]}
            />
          </div>
