...
function AdminLogin() {
  ...
  const { register, onSubmit, errors, isLoading } = useLoginForm<ApiResponse<Partial<Admin>>>({
        ...
        <div className="md:w-5/12 bg-[#4B49AC]/10 p-8 flex flex-col justify-center relative">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600">
              Track productivity, assign tasks, and boost team performance with our comprehensive
              dashboard.
            </p>
          </div>
        </div>
