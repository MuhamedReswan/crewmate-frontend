            ...
            <div className="max-w-7xl mx-auto px-6 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-foreground">Vendor Details</h3>
                  </div>
                </div>
                <Badge
                      ...
                      {user.estd && (
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-foreground font-medium">{user.estd} years old</p>
                          </div>
                        </div>
                      )}
                      {user.licenceNumber && (
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-muted text-sm">licenceNumber</p>
                            <p className="text-foreground font-medium">{user.licenceNumber}</p>
                          </div>
                        </div>
                      )}
                      <div className="flex items-center space-x-3">
                  ...
                  <div className="bg-[#12132D] border border-surface/20 rounded-xl p-6 md:col-span-2">
                    ...
                    <div>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {user.estd && (
                          <div className="space-y-2">
                            <p className="text-muted text-sm">Established</p>
                            <p className="text-foreground font-medium">{user.estd}</p>
                          </div>
                        )}
                        {user.location?.address && (
                          <div className="space-y-2">
                        ...
                        {user.licenceNumber && (
                          <div className="space-y-2">
                            <p className="text-muted text-sm">Licence Number</p>
                            <p className="text-foreground font-medium">{user.licenceNumber}</p>
                          </div>
                        )}
                        {user.instaId && (
                          <div className="space-y-2">
                            <p className="text-muted text-sm">Insta ID</p>
                            <p className="text-foreground font-medium">{user.instaId}</p>
                          </div>
                        )}
                        {user.points !== undefined && (
                          <div className="space-y-2">
