...
import { getServiceBoyById, getUserById, updateUserStatus } from "@/api/admin/admin";
...
const ServiceBoyDetailsPage = () => {
  ...
  const [user, setUser] = useState<ServiceBoy | null>(initialUser ?? null);
  ...
  const handleBlockToggle = async () => {
    try {
      ...
      await updateUserStatus(user._id, action, UserType.SERVICE_BOY);
